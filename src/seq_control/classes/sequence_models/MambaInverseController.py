...
class MambaInverseController(nn.Module):
    def __init__(self, hyperparam_config):
        ...
        self.d_state = hyperparam_config["MambaInverseController"]["d_state"]
        self.expand = hyperparam_config["MambaInverseController"]["expand"]
        self.d_conv = hyperparam_config["MambaInverseController"]["d_conv"]
